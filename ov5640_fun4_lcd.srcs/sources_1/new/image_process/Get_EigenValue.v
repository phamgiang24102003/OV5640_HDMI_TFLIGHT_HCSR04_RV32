...
//    parameter [3:0] VER_SPLIT = 4'd5  //垂直切割成几个区域
    ...
    //输出7个特征值
    output reg [(HOR_SPLIT*VER_SPLIT-1):0]     char1_eigenvalue  ,
    output reg [(HOR_SPLIT*VER_SPLIT-1):0]     char2_eigenvalue  ,
    output reg [(HOR_SPLIT*VER_SPLIT-1):0]     char3_eigenvalue  ,
    output reg [(HOR_SPLIT*VER_SPLIT-1):0]     char4_eigenvalue  ,
    output reg [(HOR_SPLIT*VER_SPLIT-1):0]     char5_eigenvalue  ,
    output reg [(HOR_SPLIT*VER_SPLIT-1):0]     char6_eigenvalue  ,
    output reg [(HOR_SPLIT*VER_SPLIT-1):0]     char7_eigenvalue   
);
