module ov5640_rgb_init_table #(	parameter DATA_WIDTH 		= 24,
...
(
	...
	initial begin
		...
		rom[7]   = 24'h3037_13;	// PLL root divider, PLL pre-divider
		rom[8]   = 24'h3108_01;	// PCLK and SCLK2x root divider
		rom[9]   = 24'h3630_36;	// Analog control
		rom[10]  = 24'h3631_0e;
		rom[11]  = 24'h3632_e2;
		rom[12]  = 24'h3633_12;
		rom[13]  = 24'h3621_e0;
		...
		rom[44]  = 24'h3c0a_9c;
		rom[45]  = 24'h3c0b_40;
		rom[46]  = 24'h3810_00;	// Timing H offset[11:8]
		rom[47]  = 24'h3811_10;	// Timing H offset[7:0]
		rom[48]  = 24'h3812_00;	// Timing V offset[10:8]
		rom[49]  = 24'h3708_64;
		...
		rom[55]  = 24'h302e_00;
		rom[56]  = 24'h4300_61;	// RGB565 output format
		rom[57]  = 24'h501f_01;	// RGB565 enable
		rom[58]  = 24'h440e_00;
		rom[59]  = 24'h5000_a7;	// Lenc, gamma, BPC, WPC, CIP on
		rom[60]  = 24'h3a0f_30;	// AEC stable range high
		rom[61]  = 24'h3a10_28;	// AEC stable range low
		rom[62]  = 24'h3a1b_30;	// AEC range out high
		rom[63]  = 24'h3a1e_26;	// AEC range out low
		rom[64]  = 24'h3a11_60;
		rom[65]  = 24'h3a1f_14;
		rom[66]  = 24'h5800_23;
		rom[67]  = 24'h5801_14;
		...
		rom[209] = 24'h3036_69;
		rom[210] = 24'h3c07_07;
		rom[211] = {16'h3820, IMAGE_FLIP_DAT};
		rom[212] = {20'h38210, IMAGE_MIRROR_DAT};
		rom[213] = 24'h3814_31;
		rom[214] = 24'h3815_31;
		rom[215] = 24'h3800_00;
		rom[216] = 24'h3801_00;
		...
		rom[224] = {16'h3809, IMAGE_WIDTH[7:0]};
		rom[225] = {16'h380a, IMAGE_HEIGHT[15:8]};
		rom[226] = {16'h380b, IMAGE_HEIGHT[7:0]};
		rom[227] = 24'h380c_07;
		rom[228] = 24'h380d_64;
		rom[229] = 24'h380e_02;
		rom[230] = 24'h380f_e4;
		...
		rom[249] = 24'h5001_83;
		rom[250] = 24'h3503_00;
		rom[251] = 24'h4740_20;	// VSYNC polarity
	end
